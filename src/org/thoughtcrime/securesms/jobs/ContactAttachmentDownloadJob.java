...
public class ContactAttachmentDownloadJob extends AttachmentDownloadJob {
      ...
      throws IOException
  {
    ...
    try (InputStream contactStream = PartAuthority.getAttachmentStream(context, attachment.getDataUri())) {
      ContactStream.Reader contactReader = new ContactStream.Reader(contactStream);
      ...
      ContactStream.Stream           contactWithAvatarStream = new ContactStream.Stream(contact, avatarStream);
